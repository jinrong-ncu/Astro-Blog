...
The most unique part of this project wasn't the tech stack, but *how* I built it. I didn't write every line of CSS manually. Instead, I partnered with an AI Agent (荣十一/Cursor) to "Vibe Code" the design.
